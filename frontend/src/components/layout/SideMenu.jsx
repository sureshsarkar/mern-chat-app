    ...
    <div className="row">
        <div className="col-sm-auto bg-blue sticky-top min-vh-100 ">
            <div className="d-flex flex-sm-column flex-row flex-nowrap align-items-center sticky-top">
                <Link to="/" className="d-block link-dark text-decoration-none nav-link" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
                    <i className="bi-chatd fs-3 text-light">H</i>
                </Link>
                ...
                <li className="nav-item">
                        ...
                        <i className="bi bi-plus-square fs-3 text-light"></i>
                        </Link>
                    </li>
                    :''}
                    {!authUser ? 
                    <li className="nav-item">
                        <Link to="login" className="nav-link " title="Login" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Home">
                            <i className="bi bi-box-arrow-in-right fs-3 text-light"></i>
                        </Link>
                    </li>
                    :''}
                     {authUser ? 
